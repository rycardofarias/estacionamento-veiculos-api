insert into USUARIOS (id, username, password, role)
    values (100, 'ricardo@email.com.br', '$2a$12$yHyEFmRcQQFPDo4dmEPqSu1f8ANyzg2U/YNkn.wfbVNFA5opcbiEG', 'ROLE_ADMIN');
insert into USUARIOS (id, username, password, role)
    values (101, 'bia@email.com.br', '$2a$12$yHyEFmRcQQFPDo4dmEPqSu1f8ANyzg2U/YNkn.wfbVNFA5opcbiEG', 'ROLE_CLIENTE');
insert into USUARIOS (id, username, password, role)
    values (102, 'bob@email.com.br', '$2a$12$yHyEFmRcQQFPDo4dmEPqSu1f8ANyzg2U/YNkn.wfbVNFA5opcbiEG', 'ROLE_CLIENTE');
